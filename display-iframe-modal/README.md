...
In the folder where you want this sample to be cloned, create a new project by running `hs project create --templateSource="ianmatthewsfreelance/ui-extensions-examples" --location="display-iframe-modal" --name="display-iframe-modal" --template="display-iframe-modal"`
